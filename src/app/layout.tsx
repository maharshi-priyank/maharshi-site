...
import { Archivo, Manrope, Permanent_Marker } from "next/font/google";
...
export default function RootLayout({ children }: LayoutProps<"/">) {
  return (
    <html lang="en" suppressHydrationWarning className={`${archivo.variable} ${manrope.variable} ${marker.variable} antialiased`}>
